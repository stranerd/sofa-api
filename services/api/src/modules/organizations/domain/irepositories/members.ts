...
export interface IMemberRepository {
	...
	add: (data: { organizationId: string, members: { email: string, user: EmbeddedUser | null, type: MemberTypes }[] }) => Promise<MemberEntity[]>
	request: (data: { email: string, user: EmbeddedUser | null, type: MemberTypes, organizationId: string, withCode: boolean }) => Promise<MemberEntity>
